...
| O16 | The retrieval relevance floor was calibrated at ~10 episodes and spot-checked as the corpus grew. Now that all 303 are ingested, re-measure once — a larger corpus raises the chance of a spurious high-similarity match on an off-topic query. | Backend |
